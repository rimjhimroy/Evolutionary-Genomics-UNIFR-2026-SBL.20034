...
You should see files ending in `_f`.  
The `_f` file is the full STRUCTURE output for one run, including run settings, likelihood values, and the detailed ancestry report for each individual. You can open one `_f` file and look for the corresponding section headings, such as  `Overall proportion of membership`, `Estimated Ln Prob of Data`, `Inferred ancestry of individuals`, `Allele-freq. divergence among pops`, and `Average distances`.  
...
- `ddrad_pca.png` and `wgs_pca.png`: each point is one individual; compare whether ddRAD and WGS separate the populations in similar ways
...
- `wgs_scaffold1_window_fst.tsv`
- `ddrad_scaffold1_window_fst.tsv`
- `wgs_scaffold1_fst.png`
- `ddrad_scaffold1_fst.png`
