...
The reference CLUMPP files provided with the practical are in:

`dataset-tutorial3/01-structure-ddrad/03-reference-clumpp-files/`

Copy the `paramfile` into the current folder. It specifies the parameters for CLUMPP, such as the number of clusters (K), the number of replicates, the number of individuals, and the input and output file names. 
